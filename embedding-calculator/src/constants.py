...
class ENV(Constants):
    ...
    EXTRA_PLUGINS = get_env_split('EXTRA_PLUGINS', 'facenet.LandmarksDetector,facialattributes.AgeDetector,facialattributes.GenderDetector,facenet.facemask.MaskDetector,facenet.PoseEstimator')
